...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static final class Any extends NamedFastMatcher {
        ...
        public CharMatcher mo465or(CharMatcher charMatcher) {
    ...
    private static final class C0330Is extends FastMatcher {
        ...
        /* JADX INFO: renamed from: or */
        public CharMatcher mo465or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo465or(charMatcher);
        }
    ...
    private static final class C0331Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;

        C0331Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        return m464is(charSequence.charAt(0));
    }
    ...
    public static CharMatcher m464is(char c) {
        return new C0330Is(c);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m464is((char) bitSet.nextSetBit(0));
        }
        if (i != 2) {
    ...
    /* JADX INFO: renamed from: or */
    public CharMatcher mo465or(CharMatcher charMatcher) {
        return new C0331Or(this, charMatcher);
    }
