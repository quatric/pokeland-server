...
public abstract class ByteSource {
    ...
    private static class ByteArrayByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            return Optional.m468of(Long.valueOf(this.length));
        }
    ...
    private static final class EmptyByteSource extends ByteArrayByteSource {
        ...
        @Override // com.google.common.io.ByteSource.ByteArrayByteSource, com.google.common.p015io.ByteSource
        public byte[] read() {
            return this.bytes;
        }
    ...
    private final class SlicedByteSource extends ByteSource {
        ...
        public Optional<Long> sizeIfKnown() {
            ...
            return Optional.m468of(Long.valueOf(Math.min(this.length, jLongValue - Math.min(this.offset, jLongValue))));
        }
    ...
    public byte[] read() throws Throwable {
        ...
        try {
            try {
                byte[] byteArray = ByteStreams.toByteArray((InputStream) closerCreate.register(openStream()));
                closerCreate.close();
                return byteArray;
            } catch (Throwable th) {
                throw closerCreate.rethrow(th);
