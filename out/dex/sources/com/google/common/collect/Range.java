...
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {
    ...
    /* JADX INFO: renamed from: com.google.common.collect.Range$3 */
    static /* synthetic */ class C05313 {
    ...
    public static <C extends Comparable<?>> Range<C> downTo(C c, BoundType boundType) {
        int i = C05313.$SwitchMap$com$google$common$collect$BoundType[boundType.ordinal()];
        if (i == 1) {
