...
public final class CacheBuilderSpec {
    private static final Splitter KEYS_SPLITTER = Splitter.m473on(',').trimResults();
    private static final Splitter KEY_VALUE_SPLITTER = Splitter.m473on('=').trimResults();
    ...
    CacheBuilder<Object, Object> toCacheBuilder() {
        ...
        if (this.keyStrength != null) {
            if (C03581.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.keyStrength.ordinal()] != 1) {
                throw new AssertionError();
            }
            cacheBuilderNewBuilder.weakKeys();
        }
        if (this.valueStrength != null) {
            int i = C03581.$SwitchMap$com$google$common$cache$LocalCache$Strength[this.valueStrength.ordinal()];
            if (i == 1) {
