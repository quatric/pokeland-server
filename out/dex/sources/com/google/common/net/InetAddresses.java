...
import com.google.common.p015io.ByteStreams;
...
public final class InetAddresses {
    ...
    private static final Splitter IPV4_SPLITTER = Splitter.m473on('.').limit(4);
    ...
    public static TeredoInfo getTeredoInfo(Inet6Address inet6Address) {
        ...
        int i2 = 65535 & (ByteStreams.newDataInput(address, 10).readShort() ^ (-1));
    ...
    private static byte[] textToNumericFormatV6(String str) {
        ...
        if (i >= 0) {
            ...
            if (strArrSplit[strArrSplit.length - 1].length() == 0 && (length2 = length2 - 1) != 0) {
                return null;
            }
        } else {
