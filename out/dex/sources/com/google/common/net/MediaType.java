...
public final class MediaType {
    ...
    private static final ImmutableListMultimap<String, String> UTF_8_CONSTANT_PARAMETERS = ImmutableListMultimap.m505of(CHARSET_ATTRIBUTE, Ascii.toLowerCase(Charsets.UTF_8.name()));
    ...
    private static final Joiner.MapJoiner PARAMETER_JOINER = Joiner.m467on("; ").withKeyValueSeparator("=");
    ...
    public static MediaType create(String str, String str2) {
        return create(str, str2, ImmutableListMultimap.m504of());
    }
    ...
    private static MediaType createConstant(String str, String str2) {
        return addKnownType(new MediaType(str, str2, ImmutableListMultimap.m504of()));
    }
    ...
    public Optional<Charset> charset() {
        ImmutableSet immutableSetCopyOf = ImmutableSet.copyOf((Collection) this.parameters.get(CHARSET_ATTRIBUTE));
        int size = immutableSetCopyOf.size();
        if (size == 0) {
            return Optional.absent();
        }
        if (size == 1) {
            return Optional.m468of(Charset.forName((String) Iterables.getOnlyElement(immutableSetCopyOf)));
        }
    ...
    public boolean m600is(MediaType mediaType) {
