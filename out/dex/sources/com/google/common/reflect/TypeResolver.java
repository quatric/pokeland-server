...
public final class TypeResolver {
    ...
    private static final class WildcardCapturer {
        ...
        private final AtomicInteger f351id;

        private WildcardCapturer() {
            this.f351id = new AtomicInteger();
        }
        ...
        Type capture(Type type) {
            ...
            return Types.newArtificialTypeVariable(WildcardCapturer.class, "capture#" + this.f351id.incrementAndGet() + "-of ? extends " + Joiner.m466on(Typography.amp).join(wildcardType.getUpperBounds()), wildcardType.getUpperBounds());
        }
    }
