...
public final class zah extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getResolveAccountRequest", m430id = 2)
    private final ResolveAccountRequest zasa;

    @SafeParcelable.Constructor
    zah(@SafeParcelable.Param(m431id = 1) int i, @SafeParcelable.Param(m431id = 2) ResolveAccountRequest resolveAccountRequest) {
        this.zale = i;
