...
import com.google.android.gms.common.C0271R;
...
public final class ConnectionErrorMessages {
    ...
    public static String getDefaultNotificationChannelName(Context context) {
        return context.getResources().getString(C0270R.string.common_google_play_services_notification_channel_name);
    }
    ...
    public static String getErrorDialogButtonMessage(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C0270R.string.common_google_play_services_install_button);
        }
        if (i != 2) {
            return i != 3 ? resources.getString(R.string.ok) : resources.getString(C0270R.string.common_google_play_services_enable_button);
        }
        return resources.getString(C0270R.string.common_google_play_services_update_button);
    }
    ...
    public static String getErrorMessage(Context context, int i) {
        ...
        if (i == 1) {
            return resources.getString(C0270R.string.common_google_play_services_install_text, appName);
        }
        if (i == 2) {
            return DeviceProperties.isWearableWithoutPlayStore(context) ? resources.getString(C0270R.string.common_google_play_services_wear_update_text) : resources.getString(C0270R.string.common_google_play_services_update_text, appName);
        }
        if (i == 3) {
            return resources.getString(C0270R.string.common_google_play_services_enable_text, appName);
        }
        if (i == 5) {
        ...
        if (i == 9) {
            return resources.getString(C0270R.string.common_google_play_services_unsupported_text, appName);
        }
        if (i == 20) {
        ...
        switch (i) {
            ...
            case 18:
                return resources.getString(C0270R.string.common_google_play_services_updating_text, appName);
            default:
                return resources.getString(C0271R.string.common_google_play_services_unknown_issue, appName);
        }
    }
    ...
    public static String getErrorNotificationTitle(Context context, int i) {
        ...
        return strZaa == null ? context.getResources().getString(C0270R.string.common_google_play_services_notification_ticker) : strZaa;
    }
    ...
    public static String getErrorTitle(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0270R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C0270R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C0270R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    private static String zaa(Context context, String str, String str2) {
        ...
        if (strZaa == null) {
            strZaa = resources.getString(C0271R.string.common_google_play_services_unknown_issue);
        }
