...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    @SafeParcelable.Field(getter = "getErrorCode", m430id = 2)
    private final int zzh;

    @SafeParcelable.Field(getter = "getResolution", m430id = 3)
    private final PendingIntent zzi;

    @SafeParcelable.Field(getter = "getErrorMessage", m430id = 4)
    ...
    ConnectionResult(@SafeParcelable.Param(m431id = 1) int i, @SafeParcelable.Param(m431id = 2) int i2, @SafeParcelable.Param(m431id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(m431id = 4) String str) {
        this.zzg = i;
        this.zzh = i2;
