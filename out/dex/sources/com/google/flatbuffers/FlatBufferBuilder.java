...
public class FlatBufferBuilder {
    ...
    public FlatBufferBuilder(int i, ByteBufferFactory byteBufferFactory, ByteBuffer byteBuffer, Utf8 utf8) {
        ...
        if (byteBuffer != null) {
            this.f353bb = byteBuffer;
            this.f353bb.clear();
            this.f353bb.order(ByteOrder.LITTLE_ENDIAN);
        } else {
            this.f353bb = byteBufferFactory.newByteBuffer(i);
        }
        this.utf8 = utf8;
    }
    ...
    public void clear() {
        this.space = this.f353bb.capacity();
        this.f353bb.clear();
        this.minalign = 1;
        while (true) {
    ...
    public int createString(CharSequence charSequence) {
        ...
        this.space = i;
        byteBuffer.position(i);
        this.utf8.encodeUtf8(charSequence, this.f353bb);
        return endVector();
    }
    ...
    public int createString(ByteBuffer byteBuffer) {
        ...
        ByteBuffer byteBuffer2 = this.f353bb;
        int i = this.space - iRemaining;
        this.space = i;
        byteBuffer2.position(i);
        this.f353bb.put(byteBuffer);
        return endVector();
    }
    ...
    public ByteBuffer createUnintializedVector(int i, int i2, int i3) {
        ...
        ByteBuffer byteBufferOrder = this.f353bb.slice().order(ByteOrder.LITTLE_ENDIAN);
    ...
    public int endObject() {
        ...
        loop2: while (true) {
            ...
            int iCapacity = this.f353bb.capacity() - this.vtables[i4];
            int i5 = this.space;
            short s = this.f353bb.getShort(iCapacity);
            if (s == this.f353bb.getShort(i5)) {
                int i6 = 2;
                while (true) {
                    if (i6 >= s) {
                        i = this.vtables[i4];
                    ...
                    if (this.f353bb.getShort(iCapacity + i6) != this.f353bb.getShort(i5 + i6)) {
                        break;
                    }
                    i6 += 2;
                }
        ...
        if (i != 0) {
            this.space = this.f353bb.capacity() - iOffset;
            this.f353bb.putInt(this.space, i - iOffset);
        } else {
    ...
    protected void finish(int i, boolean z) {
        ...
        addOffset(i);
        if (z) {
            addInt(this.f353bb.capacity() - this.space);
        }
        this.f353bb.position(this.space);
        this.finished = true;
    }
    ...
    public int offset() {
        return this.f353bb.capacity() - this.space;
    }
    ...
    public void prep(int i, int i2) {
        ...
        int iCapacity = ((((this.f353bb.capacity() - this.space) + i2) ^ (-1)) + 1) & (i - 1);
        while (this.space < iCapacity + i + i2) {
            int iCapacity2 = this.f353bb.capacity();
            ByteBuffer byteBuffer = this.f353bb;
            this.f353bb = growByteBuffer(byteBuffer, this.bb_factory);
            if (byteBuffer != this.f353bb) {
                this.bb_factory.releaseByteBuffer(byteBuffer);
            }
            this.space += this.f353bb.capacity() - iCapacity2;
        }
        pad(iCapacity);
    }
    ...
    public void required(int i, int i2) {
        int iCapacity = this.f353bb.capacity() - i;
        if (this.f353bb.getShort((iCapacity - this.f353bb.getInt(iCapacity)) + i2) != 0) {
            return;
        }
    ...
    public byte[] sizedByteArray() {
        return sizedByteArray(this.space, this.f353bb.capacity() - this.space);
    }

    public byte[] sizedByteArray(int i, int i2) {
        finished();
        byte[] bArr = new byte[i2];
        this.f353bb.position(i);
        this.f353bb.get(bArr);
        return bArr;
    }

    public InputStream sizedInputStream() {
        finished();
        ByteBuffer byteBufferDuplicate = this.f353bb.duplicate();
        byteBufferDuplicate.position(this.space);
        byteBufferDuplicate.limit(this.f353bb.capacity());
