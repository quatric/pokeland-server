...
public abstract class Optional<T> implements Serializable {
    ...
    public static <T> Optional<T> m448of(T t) {
    ...
    public abstract Optional<T> mo441or(Optional<? extends T> optional);

    @Beta
    /* JADX INFO: renamed from: or */
    public abstract T mo442or(Supplier<? extends T> supplier);

    /* JADX INFO: renamed from: or */
    public abstract T mo443or(T t);
