...
public abstract class CharMatcher implements Predicate<Character> {
    ...
    private static final class Any extends NamedFastMatcher {
        ...
        public CharMatcher mo445or(CharMatcher charMatcher) {
    ...
    /* JADX INFO: renamed from: com.google.api.client.repackaged.com.google.common.base.CharMatcher$Is */
    private static final class C0295Is extends FastMatcher {
        ...
        /* JADX INFO: renamed from: or */
        public CharMatcher mo445or(CharMatcher charMatcher) {
            return charMatcher.matches(this.match) ? charMatcher : super.mo445or(charMatcher);
        }
    ...
    private static final class C0296Or extends CharMatcher {
        final CharMatcher first;
        final CharMatcher second;

        C0296Or(CharMatcher charMatcher, CharMatcher charMatcher2) {
            this.first = (CharMatcher) Preconditions.checkNotNull(charMatcher);
            this.second = (CharMatcher) Preconditions.checkNotNull(charMatcher2);
        }
    ...
    public static CharMatcher anyOf(CharSequence charSequence) {
        ...
        return m444is(charSequence.charAt(0));
    }
    ...
    public static CharMatcher m444is(char c) {
        return new C0295Is(c);
    }
    ...
    private static CharMatcher precomputedPositive(int i, BitSet bitSet, String str) {
        ...
        if (i == 1) {
            return m444is((char) bitSet.nextSetBit(0));
        }
        if (i != 2) {
    ...
    /* JADX INFO: renamed from: or */
    public CharMatcher mo445or(CharMatcher charMatcher) {
        return new C0296Or(this, charMatcher);
    }
