...
/* JADX INFO: renamed from: com.amazon.device.iap.internal.b.a.b */
/* JADX INFO: compiled from: PurchaseResponseCommandV1.java */
/* JADX INFO: loaded from: /Volumes/SSD/larsen/pokeland/apk/classes.dex */
public final class C0200b extends AbstractC0201c {

    /* JADX INFO: renamed from: a */
    private static final String f161a = "b";

    public C0200b(C0218e c0218e) {
        super(c0218e, "1.0");
    }

    /* JADX INFO: renamed from: a */
    private void m327a(String str, String str2, String str3) {
        ...
        try {
            ...
            if (PurchaseResponse.RequestStatus.safeValueOf(jSONObject.getString("orderStatus")) == PurchaseResponse.RequestStatus.SUCCESSFUL) {
                C0234a.m359a().m367a(str, str2, C0242a.m398a(jSONObject, str2, str).getReceiptId(), str3);
            }
        } catch (Throwable th) {
            C0246e.m414b(f161a, "Error in savePendingReceipt: " + th);
        }
    }
    ...
    protected boolean mo326a(SuccessResult successResult) throws Exception {
        ...
        if (str == null || !C0235b.m370a().m371a(str)) {
            m355b().m342d().m350b();
            return true;
        }
        ...
        if (requestStatusSafeValueOf == PurchaseResponse.RequestStatus.SUCCESSFUL) {
            try {
                ...
                if (ProductType.CONSUMABLE == receiptM398a.getProductType()) {
                    m327a(str, str2, str4);
                }
