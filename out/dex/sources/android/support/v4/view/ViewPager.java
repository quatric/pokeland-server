...
public class ViewPager extends ViewGroup {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (!layoutParams2.isDecor && (itemInfoInfoForChild = infoForChild(childAt2)) != null) {
                    ...
                    if (layoutParams2.needsMeasure) {
                        ...
                        childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (f * layoutParams2.widthFactor), Ints.MAX_POWER_OF_TWO), View.MeasureSpec.makeMeasureSpec((i6 - measuredHeight2) - measuredHeight, Ints.MAX_POWER_OF_TWO));
                    }
    ...
    /* JADX WARN: Code duplicated, block: B:48:0x00bb A[DONT_INVERT] */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredWidth2, Ints.MAX_POWER_OF_TWO);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight2, Ints.MAX_POWER_OF_TWO);
        this.mInLayout = true;
        populate();
        ...
        for (int i11 = 0; i11 < childCount2; i11++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (measuredWidth2 * layoutParams.widthFactor), Ints.MAX_POWER_OF_TWO), this.mChildHeightMeasureSpec);
            }
        }
    }
    ...
    /* JADX WARN: Code duplicated, block: B:65:0x00fe A[PHI: r7 r10 r15
