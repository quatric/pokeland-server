...
public class NotificationCompat {
    ...
    public static class Action extends NotificationCompatBase.Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m2008clone() {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            boolean z2 = true;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C0003R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C0003R.id.actions);
            if (!z || this.mBuilder.mActions == null || (iMin = Math.min(this.mBuilder.mActions.size(), 3)) <= 0) {
                z2 = false;
            } else {
                for (int i = 0; i < iMin; i++) {
                    remoteViewsApplyStandardTemplate.addView(C0003R.id.actions, generateActionButton(this.mBuilder.mActions.get(i)));
                }
            }
            int i2 = z2 ? 0 : 8;
            remoteViewsApplyStandardTemplate.setViewVisibility(C0003R.id.actions, i2);
            remoteViewsApplyStandardTemplate.setViewVisibility(C0003R.id.action_divider, i2);
        ...
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                ...
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C0003R.dimen.notification_right_icon_size);
                    ...
                    if (Build.VERSION.SDK_INT >= 21) {
                        remoteViews.setImageViewBitmap(C0003R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize2, this.mBuilder.getColor()));
                    } else {
            ...
            if (this.mBuilder.mContentInfo == null) {
                if (this.mBuilder.mNumber > 0) {
                    if (this.mBuilder.mNumber > resources.getInteger(C0003R.integer.status_bar_notification_info_maxnum)) {
                        ...
                        remoteViews.setTextViewText(C0003R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                    }
                ...
                if (z4 && Build.VERSION.SDK_INT >= 16) {
                    if (z2) {
                        remoteViews.setTextViewTextSize(C0003R.id.text, 0, resources.getDimensionPixelSize(C0003R.dimen.notification_subtext_size));
                    }
                ...
                remoteViews.setViewVisibility(C0003R.id.line3, z3 ? 0 : 8);
                return remoteViews;
            }
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m2009clone() {
            WearableExtender wearableExtender = new WearableExtender();
