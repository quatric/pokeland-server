...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    /* JADX INFO: renamed from: android.support.v4.content.ModernAsyncTask$4 */
    static /* synthetic */ class C00474 {
    ...
    public final ModernAsyncTask<Params, Progress, Result> executeOnExecutor(Executor executor, Params... paramsArr) {
        ...
        int i = C00474.$SwitchMap$android$support$v4$content$ModernAsyncTask$Status[this.mStatus.ordinal()];
        if (i == 1) {
