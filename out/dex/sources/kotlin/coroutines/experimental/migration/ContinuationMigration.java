...
final class ContinuationMigration<T> implements Continuation<T> {
    ...
    public void resumeWith(@NotNull Object result) {
        if (Result.m2022isSuccessimpl(result)) {
            this.continuation.resume(result);
        }
        Throwable thM2018exceptionOrNullimpl = Result.m2018exceptionOrNullimpl(result);
        if (thM2018exceptionOrNullimpl != null) {
            this.continuation.resumeWithException(thM2018exceptionOrNullimpl);
        }
    }
}
