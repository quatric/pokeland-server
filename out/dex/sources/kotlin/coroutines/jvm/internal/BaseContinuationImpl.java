    ...
    public final void resumeWith(@NotNull Object result) {
        ...
        while (true) {
            ...
            try {
                ...
                result = Result.m2015constructorimpl(objInvokeSuspend);
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                result = Result.m2015constructorimpl(ResultKt.createFailure(th));
            }
