...
public final class ResultKt {
    ...
    @SinceKotlin(version = "1.3")
    @InlineOnly
    private static final <R, T> R fold(@NotNull Object obj, Function1<? super T, ? extends R> function1, Function1<? super Throwable, ? extends R> function2) {
        Throwable thM2018exceptionOrNullimpl = Result.m2018exceptionOrNullimpl(obj);
        return thM2018exceptionOrNullimpl == null ? function1.invoke(obj) : function2.invoke(thM2018exceptionOrNullimpl);
    }
    ...
    private static final <R, T extends R> R getOrDefault(@NotNull Object obj, R r) {
        return Result.m2021isFailureimpl(obj) ? r : obj;
    }
    ...
    private static final <R, T extends R> R getOrElse(@NotNull Object obj, Function1<? super Throwable, ? extends R> function1) {
        Throwable thM2018exceptionOrNullimpl = Result.m2018exceptionOrNullimpl(obj);
        return thM2018exceptionOrNullimpl == null ? obj : function1.invoke(thM2018exceptionOrNullimpl);
    }
    ...
    private static final <R, T> Object map(@NotNull Object obj, Function1<? super T, ? extends R> function1) {
        if (!Result.m2022isSuccessimpl(obj)) {
            return Result.m2015constructorimpl(obj);
        }
        Result.Companion companion = Result.INSTANCE;
        return Result.m2015constructorimpl(function1.invoke(obj));
    }
    ...
    private static final <R, T> Object mapCatching(@NotNull Object obj, Function1<? super T, ? extends R> function1) {
        ...
        try {
            ...
            return Result.m2015constructorimpl(createFailure(th));
        }
    }
    ...
    private static final <T> Object onFailure(@NotNull Object obj, Function1<? super Throwable, Unit> function1) {
        Throwable thM2018exceptionOrNullimpl = Result.m2018exceptionOrNullimpl(obj);
        if (thM2018exceptionOrNullimpl != null) {
            function1.invoke(thM2018exceptionOrNullimpl);
        }
        return obj;
    }
    ...
    private static final <R, T extends R> Object recover(@NotNull Object obj, Function1<? super Throwable, ? extends R> function1) {
        ...
        Result.Companion companion = Result.INSTANCE;
        return Result.m2015constructorimpl(function1.invoke(thM2018exceptionOrNullimpl));
    }
    ...
    private static final <T, R> Object runCatching(T t, Function1<? super T, ? extends R> function1) {
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m2015constructorimpl(function1.invoke(t));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m2015constructorimpl(createFailure(th));
        }
    ...
    private static final <R> Object runCatching(Function0<? extends R> function0) {
        try {
            Result.Companion companion = Result.INSTANCE;
            return Result.m2015constructorimpl(function0.invoke());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            return Result.m2015constructorimpl(createFailure(th));
        }
