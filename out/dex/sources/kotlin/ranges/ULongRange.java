...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    /* JADX INFO: compiled from: ULongRange.kt */
    @Metadata(m1982bv = {1, 0, 3}, m1983d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, m1984d2 = {"Lkotlin/ranges/ULongRange$Companion;", "", "()V", "EMPTY", "Lkotlin/ranges/ULongRange;", "getEMPTY", "()Lkotlin/ranges/ULongRange;", "kotlin-stdlib"}, m1985k = 1, m1986mv = {1, 1, 15})
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m2894containsVKZWuLQ(((ULong) comparable).getData());
    }

    /* JADX INFO: renamed from: contains-VKZWuLQ, reason: not valid java name */
    public boolean m2894containsVKZWuLQ(long value) {
    ...
    public ULong getEndInclusive() {
        return ULong.m2163boximpl(getLast());
    }

    @Override // kotlin.ranges.ClosedRange
    @NotNull
    public ULong getStart() {
        return ULong.m2163boximpl(getFirst());
    }
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m2169constructorimpl(getLast() ^ ULong.m2169constructorimpl(getLast() >>> 32))) + (((int) ULong.m2169constructorimpl(getFirst() ^ ULong.m2169constructorimpl(getFirst() >>> 32))) * 31);
    }
    ...
    public String toString() {
        return ULong.m2206toStringimpl(getFirst()) + ".." + ULong.m2206toStringimpl(getLast());
    }
}
