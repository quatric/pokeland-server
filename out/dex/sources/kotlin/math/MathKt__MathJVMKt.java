...
class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    private static final double m2002ln(double d) {
        return Math.log(d);
    }
    ...
    @InlineOnly
    /* JADX INFO: renamed from: ln */
    private static final float m2003ln(float f) {
    ...
    public static final double truncate(double d) {
        ...
        return d > ((double) 0) ? Math.floor(d) : Math.ceil(d);
    }
