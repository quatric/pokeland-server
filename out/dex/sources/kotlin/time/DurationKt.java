...
public final class DurationKt {
    ...
    private static final double m2981timeskIfJnKk(double d, double d2) {
        return Duration.m2963timesimpl(d2, d);
    }
    ...
    private static final double m2982timesmvk6XK0(int i, double d) {
        return Duration.m2964timesimpl(d, i);
    }
    ...
    public static final double toDuration(double d, @NotNull TimeUnit unit) {
        ...
        return Duration.m2937constructorimpl(DurationUnitKt.convertDurationUnit(d, unit, TimeUnit.NANOSECONDS));
    }
