...
builder.Services.AddSingleton<IEndpointHandler, ListMissionsHandler>();
...
builder.Services.AddSingleton<IEndpointHandler, AddNormalSocketCountHandler>();
builder.Services.AddSingleton<IEndpointHandler, AddPPELevelHandler>();
builder.Services.AddSingleton<IEndpointHandler, BuyStoreSizeHandler>();
builder.Services.AddSingleton<IEndpointHandler, BuyUtensilHandler>();
builder.Services.AddSingleton<IEndpointHandler, ChestStartUnlockHandler>();
builder.Services.AddSingleton<IEndpointHandler, ChestUseJitanTicketHandler>();
builder.Services.AddSingleton<IEndpointHandler, ChstgGetStageHandler>();
builder.Services.AddSingleton<IEndpointHandler, CommitHomeHandler>();
builder.Services.AddSingleton<IEndpointHandler, CommitUpdatedGuestUserProfileHandler>();
builder.Services.AddSingleton<IEndpointHandler, DoDailyProcessHandler>();
builder.Services.AddSingleton<IEndpointHandler, EqunitMountHandler>();
builder.Services.AddSingleton<IEndpointHandler, EqunitUpgradeHandler>();
builder.Services.AddSingleton<IEndpointHandler, GetAnnouncementsHandler>();
builder.Services.AddSingleton<IEndpointHandler, GetChestContentRatioHandler>();
builder.Services.AddSingleton<IEndpointHandler, GetEvepotRankingHandler>();
builder.Services.AddSingleton<IEndpointHandler, GetGuestMyslandsHandler>();
builder.Services.AddSingleton<IEndpointHandler, GetJourneyWinnersHandler>();
builder.Services.AddSingleton<IEndpointHandler, GetRankingHandler>();
builder.Services.AddSingleton<IEndpointHandler, GetReceivedGiftsHandler>();
builder.Services.AddSingleton<IEndpointHandler, GoodbyeHandler>();
builder.Services.AddSingleton<IEndpointHandler, GoodbyeChestsHandler>();
builder.Services.AddSingleton<IEndpointHandler, GoodbyeEqunitsHandler>();
builder.Services.AddSingleton<IEndpointHandler, GreetGuestUsersHandler>();
builder.Services.AddSingleton<IEndpointHandler, LinkNAHandler>();
builder.Services.AddSingleton<IEndpointHandler, ListEvepotRewardsHandler>();
builder.Services.AddSingleton<IEndpointHandler, ListStageChestContentHandler>();
builder.Services.AddSingleton<IEndpointHandler, OpenChestHandler>();
builder.Services.AddSingleton<IEndpointHandler, PdecoMountHandler>();
builder.Services.AddSingleton<IEndpointHandler, PurchaseActivateHandler>();
builder.Services.AddSingleton<IEndpointHandler, PurchaseBeginHandler>();
builder.Services.AddSingleton<IEndpointHandler, PurchaseEndHandler>();
builder.Services.AddSingleton<IEndpointHandler, PurchaseRecoveredHandler>();
builder.Services.AddSingleton<IEndpointHandler, ReceiveEvepotRewardsHandler>();
builder.Services.AddSingleton<IEndpointHandler, ReceiveGiftsHandler>();
builder.Services.AddSingleton<IEndpointHandler, RedeemWelcalHandler>();
builder.Services.AddSingleton<IEndpointHandler, SetAnnouncementStateHandler>();
builder.Services.AddSingleton<IEndpointHandler, SetFavoriteMyslandHandler>();
builder.Services.AddSingleton<IEndpointHandler, SetLoginBonusStateHandler>();
builder.Services.AddSingleton<IEndpointHandler, SetMyslandNameHandler>();
builder.Services.AddSingleton<IEndpointHandler, SetStageCollectionCompletedHandler>();
builder.Services.AddSingleton<IEndpointHandler, TmbtlEndHandler>();
builder.Services.AddSingleton<IEndpointHandler, TmbtlGetOpponentsHandler>();
builder.Services.AddSingleton<IEndpointHandler, TmbtlStartHandler>();
builder.Services.AddSingleton<IEndpointHandler, UnregisterHandler>();
builder.Services.AddSingleton<IEndpointHandler, UpdateEventHandler>();
